...
| :---: | :---: | :---: |
| ![Settings](screenshot/image (1).jpg) | ![Launcher](https://via.placeholder.com/300x600?text=Grid+Launcher) | ![Search](https://via.placeholder.com/300x600?text=Quick+Search) |
