...
// */
//
//package com.abast.homebot.circletosearch.ui.components
//
...
//            val snapshot = com.abast.homebot.circletosearch.CircleToSearchAccessibilityService.lastCapturedNodes
//            if (snapshot != null) {
//                android.util.Log.d("CopyText", "Using snapshot with ${snapshot.size} nodes")
//                detectedNodes.clear()
//                detectedNodes.addAll(snapshot)
//                com.abast.homebot.circletosearch.CircleToSearchAccessibilityService.lastCapturedNodes = null
//                view.invalidate()
//                return@launch
//            }
//
